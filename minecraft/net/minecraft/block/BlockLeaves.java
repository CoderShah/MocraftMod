...
import net.mocraft.src.MocraftBase;
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            if ((par5 & 3) == 0 && par1World.rand.nextInt(200) == 0)
            {
                ...
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(MocraftBase.orange, 1, 0));
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(MocraftBase.banana, 1, 0));
            }
        }
    }
